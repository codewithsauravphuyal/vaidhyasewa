...
<<<<<<< HEAD
              ...
              <SubTitle className="mb-4 text-primary">Book Your Demo</SubTitle>
...
<<<<<<< HEAD
                  ...
                  <Paragraph className="text-bluegray-700">Monday - Friday: 9 AM - 6 PM</Paragraph>
                  <Paragraph className="text-bluegray-700">Saturday: 10 AM - 2 PM</Paragraph>
                </div>
              </div>
              <div className="text-center">
