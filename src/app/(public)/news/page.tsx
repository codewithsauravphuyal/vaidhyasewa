    ...
    <div className="w-full min-h-screen bg-background">
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <Header className="text-primary mb-3 sm:mb-4 line-clamp-2">
                      {post.title}
                    </Header>
                    <Paragraph className="text-muted-foreground mb-4 sm:mb-6 line-clamp-2">
                      {post.excerpt}
                    </Paragraph>
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SubTitle className="text-primary mb-4 sm:mb-6">
            Subscribe to Our Newsletter
          </SubTitle>
          <ParagraphLarge className="text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto">
          ...
          <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-2">
            ...
            <Button className="h-10 sm:h-12 bg-primary hover:bg-primary/90 text-primary-foreground">Subscribe</Button>
          </div>
        </div>
      </section>
    </div>
