      ...
      <section className="relative py-20 md:py-28 bg-white_A700 overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <ParagraphLarge className="text-bluegray_500 max-w-2xl mx-auto mb-4">
                    ...
                    {category.faqs.map((faq, idx) => {
                      ...
                      return (
                        <div key={faqId} className="p-4 md:p-6">
                          ...
                          <div
                            className={`mt-3 overflow-hidden transition-all duration-300 ease-in-out ${expandedFAQ === faqId ? "max-h-48 opacity-100" : "max-h-0 opacity-0"
                              }`}
                          >
