      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
            ...
            <div>
              <h2 className="text-2xl font-bold text-dark mb-4">3. Use of Your Information</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-dark mb-4">4. Disclosure of Your Information</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-dark mb-4">5. Security of Your Information</h2>
              <p>
            ...
            <div>
              ...
              <p className="mt-2">
                Email: privacy@vaidhyasewa.com<br />
